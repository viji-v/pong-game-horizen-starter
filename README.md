...
```sh
git clone https://github.com/MLH/pong-game-horizen-starter.git
```
...
[Check this quick guide](https://github.com/MLH/pong-game-horizen-starter/blob/master/TUTORIAL.md)

## Repl.it
[![Run on Repl.it](https://repl.it/badge/github/MLH/pong-game-horizen-starter)](https://repl.it/github/MLH/pong-game-horizen-starter)
